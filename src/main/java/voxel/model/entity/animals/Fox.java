...
public class Fox extends Entity {
    ...
    public static String MODEL_PATH = "Models/Quirky-Series-FREE-Animals-v1.4/3D Files/GLTF/Animations/Muskrat_Animations.glb";
    ...
    public Fox(double x, double y, double z) {
        super(x, y, z);
        setSize(0.8f, 5f, 2f); // Taille proche du mouton
    }
